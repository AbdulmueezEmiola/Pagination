...
using Pagination.Models.Context;
using Pagination.Models.Filter;
using Pagination.Models.Services;
using Pagination.Models.Wrappers;
...
namespace Pagination.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        public async Task<IActionResult>GetAll([FromQuery]PaginationFilter filter)
        {
            ...
            var pagedData = await context.Customers.Skip((validFilter.PageNumber - 1) * validFilter.PageSize)
